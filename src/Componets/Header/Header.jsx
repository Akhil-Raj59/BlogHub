...
function Header() {
    ...
    const NavItem = ({ item }) => (
        ...
        className={({ isActive }) => {
            ...
            const activeClasses = isActive ? "text-pink-700" : "text-white hover:bg-pink-600 hover:text-white";
            const specialClasses = item.name === 'Add Post' ? "animate-glowPulse" : "hover:bg-pink-600 hover:text-white";
